...
CREATE TABLE `link_user_company` (
  ...
  CONSTRAINT `FK_link_user_company_transaction_type` FOREIGN KEY (`user_id`) REFERENCES `transaction_type` (`id`)
...
INSERT INTO `link_user_company` VALUES (2,1);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Transactions informations';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `transaction_type` VALUES (1,'a',1,0);
...
INSERT INTO `user` VALUES (1,'Emmanuel','Goldstein');
...
-- Dump completed on 2013-06-04 21:34:28
